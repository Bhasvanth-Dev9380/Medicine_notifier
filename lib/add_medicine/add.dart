...
import '../firebase/firebase.dart'; // Make sure to import your firebase service
...
class _AddMedicineScreenState extends State<AddMedicineScreen> {
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if (_selectedMedicineName.isNotEmpty) {
                      ...
                      print("Selected Medicine: $_selectedMedicineName");
  ...
  void _updateDoseTimes(String times) {
    setState(() {
      if (times == 'One Time') {
        ...
        _doseTimes = ['Dose 1', 'Dose 2'];
      } else if (times == 'Three Times') {
        _doseTimes = ['Dose 1', 'Dose 2', 'Dose 3'];
      } else if (times == 'Four Times') {
        _doseTimes = ['Dose 1', 'Dose 2', 'Dose 3', 'Dose 4'];
      }
    });
  }
  ...
  Widget _buildDoseTimeSelector(String dose) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
          ...
          onPressed: () async {
            ...
            if (pickedTime != null) {
              setState(() {
                ...
                _doseTimes[index] = '${dose.split(' ')[0]} ${pickedTime.format(context)}';
              });
            }
          },
          child: Text(dose.contains(':') ? dose.split(' ')[1] : 'Select Time'),
        ),
      ],
    );
  }
